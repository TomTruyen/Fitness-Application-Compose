...
COMMENT ON TABLE "public"."KeepAlive" IS 'Used by script to ensure that the Database will remain active';
...
CREATE POLICY "Full Access" ON "public"."KeepAlive" USING (true) WITH CHECK (true);
